...
#include "../../Calculator_GUI_2/calculation.h"
...
QT_MOC_LITERAL(1, 12, 9), // "sendError"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Calculation\0sendError\0"
};
...
void Calculation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Calculation::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Calculation::sendError)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Calculation::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Calculation.data,
      qt_meta_data_Calculation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Calculation::sendError(QString _t1)
{
